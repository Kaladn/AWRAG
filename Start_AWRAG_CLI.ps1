...
Write-Host "  python -m awrag.cli init --runtime-root `$runtime --dataset-id reviewer_docs"
Write-Host "  python -m awrag.cli intake --runtime-root `$runtime --dataset-id reviewer_docs --source <local-doc-folder>"
Write-Host "  python -m awrag.cli status --runtime-root `$runtime --dataset-id reviewer_docs"
Write-Host "  python -m awrag.cli query --runtime-root `$runtime --dataset-id reviewer_docs --question `"What does this data say?`""
Write-Host ""
